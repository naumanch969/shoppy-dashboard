...
export const SparklineAreaData = [    // xval & yval can also be other names as xvalue yvalue ( as we want)
...
export const stackedCustomSeries = [

  {
    ...
    xName: 'x_axis_of_budget',
    yName: 'y_axis_of_budget',
    name: 'Budget',                     // heading or title
    type: 'StackingColumn',             // it describes the multiple dataRows/columns is going to use in single interval
    background: 'blue',
  },
...
export const stackedPrimaryXAxis = {               // primaryXAxis  describe what type of data being showed on x axis (with what properties)
  majorGridLines: { width: 0 },
