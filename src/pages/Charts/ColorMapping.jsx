...
const ColorMappingComponent = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col items-start gap-[1rem] pb-[2rem] ' >
            ...
            <div>
                <h1 className='text-[32px] font-bold ' >ColorMaping Chart</h1>
            </div>
            ...
            <div className='w-full h-full ' >
                <ResponsiveContainer width="100%" height={400}>
                    <ScatterChart>
                        <CartesianGrid />
                        <XAxis type="number" dataKey="budget" name="stature" unit="cm" />
                        <YAxis type="number" dataKey="expense" name="weight" unit="kg" />
                        <Tooltip cursor={{ strokeDasharray: '3 3' }} />
                        <Legend />
                        <Scatter name="Budget-Expense" data={budgetExpenseEarning} fill="#8884d8" />
                    </ScatterChart>
                </ResponsiveContainer>
            </div>
...
export default ColorMappingComponent